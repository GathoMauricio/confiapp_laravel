...
if (isset($_SESSION['ctform']['error']) &&  $_SESSION['ctform']['error'] == true): /* The last form submission had 1 or more errors */ ?>
                    ...
                    <form method="post" action="#" id="contact_form">
                        ...
                        <p>
                            ...
                            <input type="text" id="ct_name2" name="ct_name2" size="35"
                                value="<?php echo htmlspecialchars(@$_SESSION['ctform']['ct_name2']); ?>">
                        </p>

                        <p>
                            <label for="ct_email">Email de tu amig@*:</label>
                            <?php echo @$_SESSION['ctform']['email_error2']; ?>
                            <input type="text" id="ct_email2" name="ct_email2" size="35"
