...
<div class="success">El mensaje ha sido enviado con éxito.</div><br />
<?php endif; ?>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI'] . $_SERVER['QUERY_STRING']) ?>" id="contact_form">
  ...
  <p>
    <label for="ct_name">Nombre de tu amig@*:</label>
    <?php echo @$_SESSION['ctform']['name_error2'] ?>
    <input type="text" id="ct_name2" name="ct_name2" size="35" value="<?php echo htmlspecialchars(@$_SESSION['ctform']['ct_name2']) ?>">
  </p>

  <p>
    <label for="ct_email">Email de tu amig@*:</label>
    <?php echo @$_SESSION['ctform']['email_error2'] ?>
    <input type="text" id="ct_email2" name="ct_email2" size="35" value="<?php echo htmlspecialchars(@$_SESSION['ctform']['ct_email2']) ?>">
  </p>
...
function process_si_contact_form()
{
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST' && @$_POST['do'] == 'contact') {
    ...
    $name2    = @$_POST['ct_name2'];    // name from the form
    $email2   = @$_POST['ct_email2'];   // email from the form
    $captcha = @$_POST['ct_captcha']; // the user's entry for the captcha code
    $name    = substr($name, 0, 64);  // limit name to 64 characters
	$GLOBALS['ct_recipient']   = $email2; // Change to your email address!  Make sure DEBUG_MODE above is 0 for mail to send!
	$GLOBALS['ct_msg_subject'] = '!Tu amigo '.$name.' te recomienda esta app!';
    ...
    if (sizeof($errors) == 0) {
      ...
      $time       = date('r');
      $message = "
	  <p align=\"center\"><b>Hola $name2<b> ¿Cómo estás?</b><br><br>
Tu amigo $name te invita a utilizar la Calculadora de Impuestos de <a href=\"http://www.siisarh.com\">www.SIISARH.com</a><br><br>
...
Android -> <a href=\"https://play.google.com/store/apps/details?id=com.lociamcorp.calculadora&hl=es\"><img src=\"http://siisarh.com/calculadora/images/android.jpg\"></a><br><br>
...
<a href=\"mailto:contactos@siisarh.com\">contactos@siisarh.com</a> | 55460213 & 55469353
      ...
      if (isset($GLOBALS['DEBUG_MODE']) && $GLOBALS['DEBUG_MODE'] == false) {
        ...
        mail($GLOBALS['ct_recipient'], $GLOBALS['ct_msg_subject'], $message, "From: {$email}\r\nReply-To: {$email}\r\nContent-type: text/html; charset=UTF-8\r\nMIME-Version: 1.0");
      }
      ...
      $_SESSION['ctform']['ct_email'] = $email;     // save email
	        $_SESSION['ctform']['ct_name2'] = $name2;       // save name from the form submission
